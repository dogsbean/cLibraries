...
public final class PlayerUtils {
    ...
    public static void animateDeath(Player player) {
        ...
        try {
            ...
            LibraryPlugin.getInstance().getPlugin().getServer().getScheduler().runTaskLater(LibraryPlugin.getInstance().getPlugin(), () -> {
    ...
    public static void animateDeath(Player player, Player watcher) {
        ...
        try {
            ...
            LibraryPlugin.getInstance().getPlugin().getServer().getScheduler().runTaskLater(LibraryPlugin.getInstance().getPlugin(), () -> ((CraftPlayer) watcher).getHandle().playerConnection.sendPacket(new PacketPlayOutEntityDestroy(new int[]{entityId})), 40L);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
